...
require 'nfe/entidades/ide/identificacao_nfe'
require 'nfe/entidades/emit/emitente'
require 'nfe/entidades/avulsa/avulsa'
require 'nfe/entidades/dest/destinatario'
require 'nfe/entidades/retirada/local_retirada'
require 'nfe/entidades/entrega/local_entrega'
require 'nfe/entidades/det/detalhes_nfe'
require 'nfe/entidades/total/total'
require 'nfe/entidades/transp/transporte'
require 'nfe/entidades/cobr/cobranca'
require 'nfe/entidades/infAdic/informacao_adicional_nfe'
require 'nfe/entidades/exporta/exportacao'
require 'nfe/entidades/compra/compra'
require 'nfe/entidades/cana/cana'
